...
// Source: github.com/luxpo/time-go2nd/micro/rpc2 (interfaces: Proxy)
...
import (
	...
	message "github.com/luxpo/time-go2nd/micro/rpc2/message"
)
...
func (m *MockProxy) Invoke(arg0 context.Context, arg1 *message.Request) (*message.Response, error) {
	m.ctrl.T.Helper()
